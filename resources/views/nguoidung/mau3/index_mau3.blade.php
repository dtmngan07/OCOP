                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <hr>
                            <h5 class="mb-3">PHẦN I</h5>
                            <p>GIỚI THIỆU</p>
                            <a href="{{ URL::to('/nguoidung/capnhatmau3phanI') }}"
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <hr>
                            <h5 class="mb-3">PHẦN II</h5>
                            <p>TỔNG QUAN VỀ TÌNH HÌNH THỊ TRƯỜNG VÀ KHẢ NĂNG THAM GIA CỦA DOANH NGHIỆP/HỢP TÁC XÃ/TỔ HỢP TÁC/HỘ KINH DOANH</p>
                            <a href="{{ URL::to('/nguoidung/capnhatmau3phanII') }}"
                                class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">
                                Xem và cập nhật
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            <i class="fas fa-file-alt" style='font-size:50px'></i>
                            <hr>
                            <h5 class="mb-3">PHẦN III</h5>
                            <p>PHƯƠNG ÁN SẢN XUẤT, KINH DOANH (3 năm)</p>
                            <a href="{{ URL::to('/nguoidung/capnhatmau3phanIII') }}"
                                class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">
                                Xem và cập nhật
                            </a>
                        </div>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            <i class="far fa-file-alt" style='font-size:50px'></i>
                            <hr>
                            <h5 class="mb-3">PHẦN IV</h5>
                            <p>PHƯƠNG ÁN TÀI CHÍNH</p>
                            <a href="{{ URL::to('/nguoidung/capnhatmau3phanIV') }}"
                                class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">
                                Xem và cập nhật
                            </a>
                        </div>
