    ...
    <div class="" id="phanI">
        ...
        <form action="{{ URL::to('/nguoidung/capnhatmau3phanI') }}"
            ...
            <div class="row mb-3">
                <label for="" class="col-md-4 col-lg-3 col-form-label">Địa chỉ trụ sở chính:</label>
                <div class="col-md-8 col-lg-9">
                    <input name="DiaChiCty" type="text" class="form-control" id="" value="" readonly>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <label for="" class="col-md-4 col-lg-3 col-form-label">Địa chỉ xưởng sản xuất:</label>
                <div class="col-md-8 col-lg-9">
                    <input name="DiaChiXuong" type="text" class="form-control" id="" value="" readonly>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <label for="" class="col-md-4 col-lg-3 col-form-label">Vốn điều lệ:</label>
                <div class="col-md-8 col-lg-9">
                    <input name="VonDieuLe" type="text" class="form-control" id="" value="" readonly>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <label for="" class="col-md-4 col-lg-3 col-form-label">Số lượng thành viên:</label>
                <div class="col-md-8 col-lg-9">
                    <input name="SoLuongThanhVien" type="text" class="form-control" id="" value="">
                </div>
            </div>
            ...
            <div class="row mb-3">
                <label for="" class="col-md-4 col-lg-3 col-form-label">Ngành, nghề sản xuất, kinh doanh:</label>
                <div class="col-md-8 col-lg-9">
                    <input name="NganhNghe" type="text" class="form-control" id="" value="">
                </div>
            </div>
