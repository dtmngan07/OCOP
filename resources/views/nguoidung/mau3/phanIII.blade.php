...
<main>
    ...
    <div class="" id="phanIII">
        ...
        <form action="{{ URL::to('/nguoidung/capnhatmau3phanIII') }}" enctype="multipart/form-data" class="row g-3"
            method="POST">
            {{ csrf_field() }}
            @if ($PhanIII != NULL)
            ...
            <div class="row mb-3">
                <div class="col-md-12 col-lg-12">
                    <textarea name="PhanTichChung" type="text" class="form-control"
                        id="PhanTichChung">{!! $PhanIII->PhanTichChung !!}</textarea>
                </div>
            </div>
            <hr>
            ...
            <div class="row mb-3">
                <div class="col-md-12 col-lg-12">
                    <textarea name="PhanTichCanhTranh" type="text" class="form-control"
                        id="PhanTichCanhTranh">{!! $PhanIII->PhanTichCanhTranh !!}</textarea>
                </div>
            </div>
            <hr>
            ...
            <div class="row mb-3">
                <div class="col-md-12 col-lg-12">
                    <textarea name="MucTieuChienLuoc" type="text" class="form-control"
                        id="MucTieuChienLuoc">{!! $PhanIII->MucTieuChienLuoc!!}</textarea>
                </div>
            </div>
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="col-sm-10">
                        <div class="col-sm-12">
                            ...
                            @if ( $PhanIII ->HoatDongSanXuat!=NULL)
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                                File bạn đã tải lên: <a
                                    href="{{ asset('file_doanhnghiep/'.$PhanIII ->HoatDongSanXuat) }}"
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="col-sm-10">
                        <div class="col-sm-12">
                            ...
                            @if ( $PhanIII ->KenhPhanPhoi!=NULL)
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                                File bạn đã tải lên: <a href="{{ asset('file_doanhnghiep/'.$PhanIII ->KenhPhanPhoi) }}"
                                    target="_blank">Bấm vào để tải</a>
                            </label>
                            @else
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-9">
                    <input name="KeHoachXucTienThuongMai" type="file" class="form-control" id="KeHoachXucTienThuongMai"
                        value="">
                </div>
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="col-sm-10">
                        <div class="col-sm-12">
                            ...
                            @if ( $PhanIII ->KeHoachXucTienThuongMai!=NULL)
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                                File bạn đã tải lên: <a
                                    href="{{ asset('file_doanhnghiep/'.$PhanIII ->KeHoachXucTienThuongMai) }}"
                                    target="_blank">Bấm vào để tải</a>
                            </label>
                            @else
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="col-sm-10">
                        <div class="col-sm-12">
                            ...
                            @if ( $PhanIII ->KeHoachMarketing!=NULL)
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                                File bạn đã tải lên: <a
                                    href="{{ asset('file_doanhnghiep/'.$PhanIII ->KeHoachMarketing) }}"
                                    target="_blank">Bấm vào để tải</a>
                            </label>
                            @else
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="col-sm-10">
                        <div class="col-sm-12">
                            ...
                            @if ( $PhanIII ->CoSoHaTang!=NULL)
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                                File bạn đã tải lên: <a href="{{ asset('file_doanhnghiep/'.$PhanIII ->CoSoHaTang) }}"
                                    target="_blank">Bấm vào để tải</a>
                            </label>
                            @else
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="col-sm-10">
                        <div class="col-sm-12">
                            ...
                            @if ( $PhanIII ->TrangThietBi!=NULL)
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                                File bạn đã tải lên: <a href="{{ asset('file_doanhnghiep/'.$PhanIII ->TrangThietBi) }}"
                                    target="_blank">Bấm vào để tải</a>
                            </label>
                            @else
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="col-sm-10">
                        <div class="col-sm-12">
                            ...
                            @if ( $PhanIII ->NhanLucDieuChinh!=NULL)
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                                File bạn đã tải lên: <a
                                    href="{{ asset('file_doanhnghiep/'.$PhanIII ->NhanLucDieuChinh) }}"
                                    target="_blank">Bấm vào để tải</a>
                            </label>
                            @else
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="col-sm-10">
                        <div class="col-sm-12">
                            ...
                            @if ( $PhanIII ->DieuKienKhac!=NULL)
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                                File bạn đã tải lên: <a href="{{ asset('file_doanhnghiep/'.$PhanIII ->DieuKienKhac) }}"
                                    target="_blank">Bấm vào để tải</a>
                            </label>
                            @else
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
