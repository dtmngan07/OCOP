    ...
    <div lass="tab-pae fade pt-3" id="phanC">
        ...
        <form action="{{ URL::to('/nguoidung/capnhatmau2phanC') }}" enctype="multipart/form-data" class="row g-3"
                    ...
                    <div class="col-sm-10">
                        <div class="form-check">
                            <input name="DatvaVanPhong[]" id="DatvaVanPhong" value="Thuê" class="form-check-input"
                                type="checkbox" {{ in_array("Thuê", explode(' - ', $PhanC->DatvaVanPhong)) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input name="DatvaVanPhong[]" id="DatvaVanPhong" value="Sở hữu" class="form-check-input"
                                type="checkbox" {{ in_array("Sở hữu", explode(' - ', $PhanC->DatvaVanPhong)) ? 'checked' : '' }}>
                            <label class="form-check-label" for="">
                                Sở hữu
                            </label>
                        </div>
                    ...
                    <div class="col-sm-10">
                        <div class="form-check">
                            <input name="DatSanXuat[]" value="Thuê" class="form-check-input" type="checkbox"
                                id="DatSanXuat" {{ in_array("Thuê", explode(' - ', $PhanC->DatSanXuat)) ? 'checked' : '' }}>
                            <label class="form-check-label" for="">
                                Thuê
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <input name="DatSanXuat[]" value="Sở hữu" class="form-check-input" type="checkbox"
                                id="DatSanXuat" {{ in_array("Sở hữu", explode(' - ', $PhanC->DatSanXuat)) ? 'checked' : '' }}>
                            <label class="form-check-label" for="">
                                Sở hữu
                            </label>
                        </div>
                    ...
                    <div class="col-sm-10">
                        <div class="form-check">
                            <input name="NguonDien[]" value="Đã mắc" class="form-check-input" type="checkbox"
                                id="NguonDien" {{ in_array("Đã mắc", explode(' - ', $PhanC->NguonDien)) ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input name="NguonDien[]" value="Đang có kế hoạch" class="form-check-input" type="checkbox"
                                id="NguonDien" {{ in_array("Đang có kế hoạch", explode(' - ', $PhanC->NguonDien)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                Đang có kế hoạch
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <input name="NguonDien[]" value="Không có" class="form-check-input" type="checkbox"
                                id="NguonDien" {{ in_array("Không có", explode(' - ', $PhanC->NguonDien)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                Không có
                            </label>
                        </div>
                    ...
                    <div class="col-sm-10">
                        ...
                        <div class="form-check">
                            <input name="NguonNuoc[]" value="Nước giếng khoan" class="form-check-input" type="checkbox"
                                id="" {{ in_array("Nước giếng khoan", explode(' - ', $PhanC->NguonNuoc)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                Nước giếng khoan
                            </label>
                        </div>
                    ...
                    <div class="col-sm-10">
                        <div class="form-check">
                            <input name="PhuongTienVanTai[]" value="Có xe ô tô" class="form-check-input" type="checkbox"
                                id="gridCheck1" {{ in_array("Có xe ô tô", explode(' - ', $PhanC->PhuongTienVanTai)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                Có xe ô tô
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <input name="PhuongTienVanTai[]" value="Xe máy" class="form-check-input" type="checkbox"
                                id="gridCheck2" {{ in_array("Xe máy", explode(' - ', $PhanC->PhuongTienVanTai)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                Xe máy
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <input name="PhuongTienVanTai[]" value="Xe trâu/bò kéo" class="form-check-input"
                                type="checkbox" id="gridCheck2" {{ in_array("Xe trâu/bò kéo", explode(' - ', $PhanC->PhuongTienVanTai)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                Xe trâu/bò kéo
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <input name="PhuongTienVanTai[]" value="Không có" class="form-check-input" type="checkbox"
                                id="gridCheck2" {{ in_array("Không có", explode(' - ', $PhanC->PhuongTienVanTai)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                Không có
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <input name="PhuongTienVanTai[]" value="Thuê" class="form-check-input" type="checkbox"
                                id="gridCheck2" {{ in_array("Thuê", explode(' - ', $PhanC->PhuongTienVanTai)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                Thuê
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <input name="PhuongTienVanTai[]" value="Phương tiện công cộng" class="form-check-input"
                                type="checkbox" id="gridCheck2" {{ in_array("Phương tiện công cộng", explode(' - ', $PhanC->PhuongTienVanTai)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                    ...
                    <div class="col-sm-10">
                        <div class="form-check">
                            <input name="PhuongTienTruyenThong[]" value="Điện thoại để bàn" class="form-check-input"
                                type="checkbox" id="gridCheck1" {{ in_array("Điện thoại để bàn", explode(' - ', $PhanC->PhuongTienTruyenThong)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                Điện thoại để bàn
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <input name="PhuongTienTruyenThong[]" value="Điện thoại di động" class="form-check-input"
                                type="checkbox" id="gridCheck2" {{ in_array("Điện thoại di động", explode(' - ', $PhanC->PhuongTienTruyenThong)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                Điện thoại di động
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <input name="PhuongTienTruyenThong[]" value="Bưu điện" class="form-check-input"
                                type="checkbox" id="gridCheck2" {{ in_array("Bưu điện", explode(' - ', $PhanC->PhuongTienTruyenThong)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                Bưu điện
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <input name="PhuongTienTruyenThong[]" value="E-mail" class="form-check-input"
                                type="checkbox" id="gridCheck2" {{ in_array("Email", explode(' - ', $PhanC->PhuongTienTruyenThong)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                E-mail
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <input name="PhuongTienTruyenThong[]" value="Website" class="form-check-input"
                                type="checkbox" id="gridCheck2" {{ in_array("Website", explode(' - ', $PhanC->PhuongTienTruyenThong)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                Website
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <input name="PhuongTienTruyenThong[]" value="Mạng xã hội" class="form-check-input"
                                type="checkbox" id="gridCheck2" {{ in_array("Mạng xã hội", explode(' - ', $PhanC->PhuongTienTruyenThong)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                Mạng xã hội
                            </label>
                        </div>
                        ...
                        <div class="form-check">
                            <input name="PhuongTienTruyenThong[]" value="Không có" class="form-check-input"
                                type="checkbox" id="gridCheck2" {{ in_array("Không có", explode(' - ', $PhanC->PhuongTienTruyenThong)) ? 'checked' : '' }}>
                            <label class="form-check-label">
                                Không có
                            </label>
                        </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="col-sm-10">
                        <div class="col-sm-12">
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                                File bạn đã tải lên: <a href="{{ asset('file_doanhnghiep/'.$PhanC ->KetQuaBanHang) }}" target="_blank">Bấm vào để tải</a>
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="col-sm-10">
                        <div class="col-sm-12">
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                                File bạn đã tải lên: <a href="{{ asset('file_doanhnghiep/'.$PhanC ->ChiPhi) }}" target="_blank">Bấm vào để tải</a>
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="col-sm-10">
                        <div class="col-sm-12">
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                                File bạn đã tải lên: <a href="{{ asset('file_doanhnghiep/'.$PhanC ->DoanhThu) }}" target="_blank">Bấm vào để tải</a>
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="col-sm-10">
                        <div class="col-sm-12">
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                                File bạn đã tải lên: <a href="{{ asset('file_doanhnghiep/'.$PhanC ->NhanLuc) }}" target="_blank">Bấm vào để tải</a>
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-8 col-lg-9">
                    <input name="NguonCungCapNguyenLieu" type="file" class="form-control" id="NguonCungCapNguyenLieu" multiple>
                </div>
                ...
                <div class="col-md-8 col-lg-9">
                    <div class="col-sm-10">
                        <div class="col-sm-12">
                            <label for="" class="col-md-12 col-lg-12 col-form-label">
                                File bạn đã tải lên: <a href="{{ asset('file_doanhnghiep/'.$PhanC ->NguonCungCapNguyenLieu) }}" target="_blank">Bấm vào để tải</a>
                            </label>
                        </div>
                    </div>
                </div>
